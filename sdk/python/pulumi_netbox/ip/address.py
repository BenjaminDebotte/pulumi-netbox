...
class _AddressState:
    def __init__(__self__, *,
                 ...
                 nat_inside_address_id: Optional[pulumi.Input[int]] = None,
                 nat_outside_addresses: Optional[pulumi.Input[Sequence[pulumi.Input['AddressNatOutsideAddressArgs']]]] = None,
                 object_type: Optional[pulumi.Input[str]] = None,
                 role: Optional[pulumi.Input[str]] = None,
    ...
    def nat_outside_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['AddressNatOutsideAddressArgs']]]]:
        return pulumi.get(self, "nat_outside_addresses")

    @nat_outside_addresses.setter
    def nat_outside_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['AddressNatOutsideAddressArgs']]]]):
...
class Address(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip_address: Optional[pulumi.Input[str]] = None,
            nat_inside_address_id: Optional[pulumi.Input[int]] = None,
            nat_outside_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AddressNatOutsideAddressArgs', 'AddressNatOutsideAddressArgsDict']]]]] = None,
            object_type: Optional[pulumi.Input[str]] = None,
            role: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            tenant_id: Optional[pulumi.Input[int]] = None,
            virtual_machine_interface_id: Optional[pulumi.Input[int]] = None,
            vrf_id: Optional[pulumi.Input[int]] = None) -> 'Address':
        """
    ...
    @property
    @pulumi.getter(name="natOutsideAddresses")
    def nat_outside_addresses(self) -> pulumi.Output[Sequence['outputs.AddressNatOutsideAddress']]:
        return pulumi.get(self, "nat_outside_addresses")
