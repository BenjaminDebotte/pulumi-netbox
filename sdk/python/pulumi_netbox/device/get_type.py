...
def get_type(manufacturer: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:device/getType:getType', __args__, opts=opts, typ=GetTypeResult).value
...
def get_type_output(manufacturer: Optional[pulumi.Input[Optional[str]]] = None,
