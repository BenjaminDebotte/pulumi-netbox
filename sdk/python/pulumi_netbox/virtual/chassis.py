...
class ChassisArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a Chassis resource.
        """
...
class _ChassisState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
        Input properties used for looking up and filtering Chassis resources.
        """
        if comments is not None:
            pulumi.set(__self__, "comments", comments)
        if custom_fields is not None:
...
class Chassis(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ChassisArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        From the [official documentation](https://docs.netbox.dev/en/stable/features/devices-cabling/#virtual-chassis):
        ...
        :param str resource_name: The name of the resource.
        :param ChassisArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ChassisArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ChassisArgs.__new__(ChassisArgs)
        ...
        super(Chassis, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            domain: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'Chassis':
        """
        Get an existing Chassis resource's state with the given name, id, and optional extra
        ...
        __props__ = _ChassisState.__new__(_ChassisState)
        ...
        __props__.__dict__["name"] = name
        __props__.__dict__["tags"] = tags
        return Chassis(resource_name, opts=opts, __props__=__props__)
