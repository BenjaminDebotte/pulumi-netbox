...
class GetMachinesResult:
    ...
    @property
    @pulumi.getter
    def vms(self) -> Sequence['outputs.GetMachinesVmResult']:
...
def get_machines(filters: Optional[Sequence[Union['GetMachinesFilterArgs', 'GetMachinesFilterArgsDict']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:virtual/getMachines:getMachines', __args__, opts=opts, typ=GetMachinesResult).value
...
def get_machines_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetMachinesFilterArgs', 'GetMachinesFilterArgsDict']]]]] = None,
