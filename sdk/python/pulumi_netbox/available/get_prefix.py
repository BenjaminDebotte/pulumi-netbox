...
class GetPrefixResult:
    ...
    def prefixes_availables(self) -> Sequence['outputs.GetPrefixPrefixesAvailableResult']:
...
def get_prefix(prefix_id: Optional[int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:available/getPrefix:getPrefix', __args__, opts=opts, typ=GetPrefixResult).value
...
def get_prefix_output(prefix_id: Optional[pulumi.Input[int]] = None,
