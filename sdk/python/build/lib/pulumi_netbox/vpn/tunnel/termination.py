...
__all__ = ['TerminationArgs', 'Termination']
...
class TerminationArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a Termination resource.
...
class _TerminationState:
    def __init__(__self__, *,
                 ...
                 virtual_machine_interface_id: Optional[pulumi.Input[int]] = None):
        """
        Input properties used for looking up and filtering Termination resources.
        :param pulumi.Input[int] device_interface_id: Exactly one of `virtual_machine_interface_id` or `device_interface_id` must be given.
        :param pulumi.Input[str] role: Valid values are `peer`, `hub` and `spoke`.
        :param pulumi.Input[int] virtual_machine_interface_id: Exactly one of `virtual_machine_interface_id` or `device_interface_id` must be given.
        """
...
class Termination(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param TerminationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TerminationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TerminationArgs.__new__(TerminationArgs)
        ...
        super(Termination, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            tunnel_id: Optional[pulumi.Input[int]] = None,
            virtual_machine_interface_id: Optional[pulumi.Input[int]] = None) -> 'Termination':
        """
        Get an existing Termination resource's state with the given name, id, and optional extra
        ...
        __props__ = _TerminationState.__new__(_TerminationState)
        ...
        __props__.__dict__["tunnel_id"] = tunnel_id
        __props__.__dict__["virtual_machine_interface_id"] = virtual_machine_interface_id
        return Termination(resource_name, opts=opts, __props__=__props__)
