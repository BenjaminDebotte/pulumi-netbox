...
def get_type(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:cluster/getType:getType', __args__, opts=opts, typ=GetTypeResult).value
...
def get_type_output(name: Optional[pulumi.Input[str]] = None,
