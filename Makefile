...
SHELL            := /bin/bash
PROJECT          := github.com/BenjaminDebotte/pulumi-netbox
NODE_MODULE_NAME := @pulumiverse/netbox
TF_NAME          := netbox
PROVIDER_PATH    := provider
PROVIDER_VERSION := 43c2dc48a2a3fee3ff3eed4a3d89db16c6dbe0b6
VERSION_PATH     := ${PROVIDER_PATH}/pkg/version.Version

JAVA_GEN         := pulumi-java-gen
JAVA_GEN_VERSION := v0.14.0
TFGEN            := pulumi-tfgen-netbox
PROVIDER         := pulumi-resource-netbox
